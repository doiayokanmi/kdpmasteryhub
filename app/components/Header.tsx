    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white shadow-md">
      ...
      <div className="flex items-center justify-between px-6 md:px-12 py-4 text-gray-800">
        ...
        <nav className="hidden md:flex space-x-6 items-center">
          <a href="#" className="hover:text-[#F97A0B]">About</a>
          <a href="#" className="hover:text-[#F97A0B]">Services</a>
          <a href="#" className="hover:text-[#F97A0B]">Contact</a>
        </nav>
        ...
        {open && (
          ...
          >
            <nav className="flex flex-col items-center gap-6 py-6">
              <a onClick={() => setOpen(false)} href="#" className="hover:text-[#F97A0B]">
                About
              </a>
              <a onClick={() => setOpen(false)} href="#" className="hover:text-[#F97A0B]">
                Services
